...
Route::middleware('auth')->group(function () {
    ...
    // Rutas protegidas relacionadas con ver episodios (puedes aplicar middleware 'subscribed' cuando exista) no funcional yet
    // Route::get('/episodes/{episode}/watch', [EpisodeController::class, 'watch'])->name('episodes.watch');
});
